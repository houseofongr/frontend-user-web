export default function Footer() {
  return (
    <footer className="w-full flex flex-col md:flex-row justify-between fixed bottom-0 text-xs md:text-sm text-center font-light inset-x-0 py-2 bg-transparent ">
      {/* 기존 */}
